        ...
        public class Expositorespejo extends JPanel {

            /**
             * Constructor.
             */
            ImageIcon imagen;
            public Expositorespejo() {
                /*
        ...
        // Etiquetas
                ...
                public Expositorespejo(GetSetImagen obj) {
                /*
                 * Creamos un layout de 4 paneles, en cada uno mostraremos una imagen
                 * "aparentemente" distinta
                 */
        ...
        * @param path Ruta de la imagen relativa al proyecto
            ...
            public static ImageIcon createImage(String path) {
                URL imgURL = Expositorespejo.class.getResource(path);
                if (imgURL != null) {
        ...
        //    Expositorespejo(GetSetImagen ori) {
